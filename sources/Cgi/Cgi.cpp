...
std::string Cgi::cgiExecute(std::string location, std::string executable ,std::string postname[], std::string	postvalue[], int j,std::string m_request, int code, char** envp)
{
    (void)code;
    code = 500;
